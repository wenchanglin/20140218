...
@interface BanBoShiminCondiView()<UITextFieldDelegate>
...
@implementation BanBoShiminCondiView
...
-(void)setupSubviews{
    ...
    [searchBtn setTitleColor:BanBoBlueColor forState:UIControlStateNormal];
    [searchBtn sizeToFit];
...
//    lineHeader.leftLabel.textColor = [UIColor hcy_colorWithString:@"#fda803"];
