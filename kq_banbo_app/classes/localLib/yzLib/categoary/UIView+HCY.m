...
@end
@implementation UIView(HCYHib)
-(UIViewController *)hcy_viewController{
    UIView *superView=self.superview;
    if (superView==nil) {
        return nil;
    }else{
        if ([NSStringFromClass([superView class]) hasPrefix:@"UIViewController"]) {
            return (UIViewController *)[self nextResponder];
        }else{
            return [superView hcy_viewController];
        }
    }
...
//        }
//    }else{
//        return [self.superview hcy_viewController];
//    }
}
