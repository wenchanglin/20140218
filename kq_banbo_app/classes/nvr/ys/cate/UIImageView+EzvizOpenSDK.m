...
@property (readwrite, nonatomic, strong, setter = ez_setImageRequestOperation:) NSURLSessionTask *ez_imageRequestOperation;
@end
...
- (NSURLSessionTask *)ez_imageRequestOperation {
    return (NSURLSessionTask *)objc_getAssociatedObject(self, @selector(ez_imageRequestOperation));
}

- (void)ez_setImageRequestOperation:(NSURLSessionTask *)imageRequestOperation {
