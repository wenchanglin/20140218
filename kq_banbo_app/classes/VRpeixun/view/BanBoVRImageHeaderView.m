...
@interface BanBoVRImageHeaderView()

@property(strong,nonatomic)UILabel *label;

@end
@implementation BanBoVRImageHeaderView
...
-(void)setupSubviews{
    UIImageView *iconView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"VR统计图标"]];
    iconView.left=22;
    iconView.top=10;
