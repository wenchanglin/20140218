...
@interface BanBoSuSheImageHeaderView()
@property(strong,nonatomic)UILabel *label;
@end
@implementation BanBoSuSheImageHeaderView
...
-(void)setupSubviews{
    UIImageView *iconView=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"宿舍管理头部图片"]];
    iconView.left=22;
    iconView.top=10;
